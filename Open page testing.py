...
from tki# importing required modules
import tkinter as tk
from tkinter import *
...
class ToDoPage(tk.Frame):
    ...
    def delete_choice(self):
        ...
        var = tk.StringVar()
        user_choice = var.get()
        btn_del_academic = tk.Radiobutton(self.choice, text='Academic Tasks', variable=var, value="Academic Tasks",
                                          state='normal',
                                          command=self.delete_all_tasks)
        btn_del_extra = tk.Radiobutton(self.choice, text='Extracurricular tasks', variable=var, value="Academic Tasks",
                                       state='normal',
                                       command=self.delete_all_tasks)
...
class StudyApp(tk.Tk):
    def __init__(self, *args, **kwargs):
        ...
        self.geometry(f'{wid# importing required modules
import tkinter as tk
from tkinter import *
from tkinter import messagebox
...
class ToDoPage(tk.Frame):
    ...
    def delete_choice(self):
        ...
        btn_del_academic = tk.Radiobutton(self.choice, text='Academic Tasks', variable=var, value="Academic Tasks",
                                          state='normal',
                                          command=self.delete_all_tasks)
        btn_del_extra = tk.Radiobutton(self.choice, text='Extracurricular tasks', variable=var, value="Extracurricular Tasks",
                                       state='normal',
                                       command=self.delete_all_tasks)
